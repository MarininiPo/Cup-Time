    ...
    return (
      ...
      <div className="container footer__container">
        ...
        <div className="footer__info">
          ...
          <p className="footer__descripshion">Проект сделан в учебных целях</p>
          <ul className="footer__developers">
            <li className="footer__developer">
              Designer:<a href="#" className="footer__developer-link"
                >Anastasia Ilina</a>
            </li>
            <li className="footer__developer">
              Developer:<a href="#" className="footer__developer-link"
                >Marinina Polina</a>
            </li>
          </ul>
        </div>
        ...
        <div className="footer__contacts">
          <a href="mailto:CUPTIME@gmail.com" className="footer__email"
            >CUPTIME@gmail.com</a>
            <ul className="footer__social__item">
                <li className="footer__social__item">
                  <a href="" className="footer__sosial-link">
                    <svg
                      width="32"
                      height="32"
                      viewBox="0 0 32 32"
